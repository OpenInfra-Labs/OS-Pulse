...
async fn main() {
    ...
    let app = Router::new()
        ...
        .route("/css/base.css", get(handlers::base_css))
        .route("/css/dashboard.css", get(handlers::dashboard_css))
        .route("/js/utils.js", get(handlers::utils_js))
        .route("/js/charts.js", get(handlers::charts_js))
        .route("/js/dashboard.js", get(handlers::dashboard_js))
